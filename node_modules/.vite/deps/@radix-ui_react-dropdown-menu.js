...
function createCollection(name) {
  ...
  const CollectionProvider = __name8((props) => {
...
}, _keys = new WeakMap(), __name8(_a, "OrderedDict"), _a);
...
var DismissableLayer = React11.forwardRef(
  ...
  __name11(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React11.useEffect(() => {
      const handleUpdate = __name11(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React11.forwardRef(__name11(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React11.useContext(DismissableLayerContext);
...
var IS_TRUE = __name11(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React11.useEffect(() => {
    ...
    const handlePointerDown = __name11((event) => {
  ...
  return {
    ...
    onPointerDownCapture: __name11(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  ...
  React11.useEffect(() => {
    const handleFocus = __name11((event) => {
  ...
  return {
    onFocusCapture: __name11(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name11(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
...
var FocusScope = React13.forwardRef(
  __name13(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
...
var Arrow = React16.forwardRef(
  __name15(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React18.forwardRef(
  __name17(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React18.forwardRef(
  __name17(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name17((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name17(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React18.forwardRef(
  __name17(function PopperArrow2(props, forwardedRef) {
...
var transformOrigin = __name17((options) => ({
...
var Portal = React19.forwardRef(
  __name18(function Portal2(props, forwardedRef) {
    var _a2;
...
__name19(useStateMachine, "useStateMachine");
var Presence = __name19((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name19((event) => {
      ...
      const handleAnimationStart = __name19((event) => {
...
__name19(usePresence, "usePresence");
...
__name19(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return (styles == null ? void 0 : styles.animationName) || "none";
}
__name19(getAnimationName, "getAnimationName");
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React21.useState(_isHydrated);
  React21.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name20(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React26.forwardRef(
  // blank line to reduce diff noise
  __name21(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React26.forwardRef(__name21(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React26.forwardRef(
  // blank line to reduce diff noise
  __name21(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name21(getDirectionAwareKey, "getDirectionAwareKey");
...
__name21(getFocusIntent, "getFocusIntent");
...
var Menu = __name22((props) => {
  ...
  const direction = useDirection(dir);
  React36.useEffect(() => {
    const handleKeyDown = __name22(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name22(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React36.useEffect(() => {
    ...
    const handleBlur = __name22(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React36.forwardRef(
  __name22(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React36.forwardRef(
  __name22(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React36.forwardRef(
  // blank line to reduce diff noise
  __name22(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React36.forwardRef(__name22(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime12.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React36.forwardRef(
  // blank line to reduce diff noise
  __name22(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name22((key) => {
      var _a2, _b;
      ...
      __name22(function updateSearch(value) {
...
var MenuGroup = React36.forwardRef(
  __name22(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React36.forwardRef(
  __name22(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React36.forwardRef(
  // blank line to reduce diff noise
  __name22(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React36.forwardRef(
  __name22(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React36.forwardRef(
  // blank line to reduce diff noise
  __name22(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name22(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React36.forwardRef(
  __name22(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React36.forwardRef(
  __name22(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React36.forwardRef(
  // blank line to reduce diff noise
  __name22(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React36.forwardRef(
  __name22(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React36.forwardRef(
  __name22(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React36.forwardRef(
  __name22(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React36.forwardRef(
  __name22(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
__name22(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name22(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name22(getCheckedState, "getCheckedState");
...
__name22(getNextMatch, "getNextMatch");
...
__name22(isPointInPolygon, "isPointInPolygon");
function isPointerInGraceArea(event, area) {
  if (!area) return false;
  const cursorPos = { x: event.clientX, y: event.clientY };
  return isPointInPolygon(cursorPos, area);
}
__name22(isPointerInGraceArea, "isPointerInGraceArea");
...
var DropdownMenu = __name23((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name23((props) => {
...
var DropdownMenuContent = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime13.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React37.forwardRef(__name23(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React37.forwardRef(__name23(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React37.forwardRef(__name23(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React37.forwardRef(__name23(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React37.forwardRef(__name23(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React37.forwardRef(
  // blank line to reduce diff noise
  __name23(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime13.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name23((props) => {
...
var DropdownMenuSubTrigger = React37.forwardRef(__name23(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime13.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React37.forwardRef(__name23(function DropdownMenuSubContent2(props, forwardedRef) {
